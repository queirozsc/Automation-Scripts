...
FROM CPG
WHERE (CPG.CPG_NUM = 3393) 
    AND (CPG_SERIE = 119)


UPDATE CPG
SET CPG_CCT_COD_PASSIVO = 20040
WHERE (CPG.CPG_NUM = 3299) 
    AND (CPG_SERIE = 119)
...
UPDATE mcc
SET mcc_obs = 'ITACLEAN COMERCIO DE PRODUTOS DE LIMPEZA'
WHERE  ((MCC.MCC_CPG_SERIE = 1119)
        AND (MCC.MCC_CPG_NUM = 3761)
        AND (MCC.MCC_TIPO = 'P')
        AND (((MCC.MCC_IND_CPG_GERACAO IS NULL OR (MCC.MCC_IND_CPG_GERACAO = 'N'))
        AND (MCC.MCC_CRE = 0)) OR (MCC.MCC_IND_CPG_GERACAO = 'S')))
...
VALUES ('64051', 107124, 1, '1871','2019-11-26 09:54:49.570','2019-11-26 09:48:17.153','201911','P','1298.68',0,1119,'10237',
        NULL,1119,3761,1,'999','MEDICWARE',NULL,NULL,NULL,
        NULL,'S','2019-11-27 00:00:00.000','N',NULL,NULL,12260,'PAG-PTI',
        NULL,NULL,NULL,NULL,1841034,NULL,NULL,NULL,NULL)