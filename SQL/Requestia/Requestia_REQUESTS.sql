...
WHERE R.CATEGORY = 'Tecnologia da Informacao'
AND R.CLOSED = 0
AND R.ABERTURA < GETDATE() - 45
AND R.ABERTURA < CAST('01 '+ RIGHT(CONVERT(CHAR(11),GETDATE(),113),8) AS datetime) 
ORDER BY R.ABERTURA


SELECT CAST('01 '+ RIGHT(CONVERT(CHAR(11),GETDATE(),113),8) AS datetime) 
WHERE R.REQUEST IN ('CSI093186', 'CSI092854', 'CSI095217', 'CSI091733')

SELECT DATENAME(m, R.ABERTURA) MES
    , MONTH(R.ABERTURA) M
    , R.MARCA
    , R.STATUS
    , COUNT(1) QTDE
...
WHERE R.CATEGORY = 'Tecnologia da Informacao'
AND R.CLOSED = 0
GROUP BY DATENAME(m, R.ABERTURA)
    , MONTH(R.ABERTURA)
    , R.MARCA
    , R.STATUS
ORDER BY M
